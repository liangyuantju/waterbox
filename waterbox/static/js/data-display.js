...
// 水位数据
var myChart4 = echarts.init(document.getElementById("water-level"));
		    var data = [0];
		    var xMax = 1;
		    var axisColor = '#fff';
		    option4 = {
...
setInterval(function() {
	$.ajax({
		...
		success: function (data) {
			...
			// 	wlOption.series[1].data[0].itemStyle.normal.color.colorStops[0].color = '#FF0000';
			// 	wlOption.series[1].data[0].itemStyle.normal.color.colorStops[1].color = '#CC0000';
			// }
			option4.series[1].data[0].value = data[0]['waterlevel'];
			...
			// 	tempOption.series[1].data[0].itemStyle.normal.color.colorStops[1].color = '#CC0000';
			// }
			option3.series[1].data[0].value = data[0]['humidity'];
